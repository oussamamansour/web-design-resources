...
var scrollToTop = new SmoothScroll('.scroll-top', {
    speed: 500
});
...
var scrollToMain = new SmoothScroll('.action-btn', {
    speed:500
});
    ...
    privacyCardText.addEventListener('scroll', function(e){
        ...
        if ((element.scrollHeight - Math.ceil(element.scrollTop) - element.clientHeight) in [0,1]) {
            ...
            privacyCardAcceptBtn.addEventListener('click', () => {
                ...
                // Hide privacy card
                document.querySelector('.privacy-card').classList.add('hidden');
            })
        } else {
...
privacyInfoBtns.forEach(item => {
    ...
    item.addEventListener('click', () => {
        ...
        // Show privacy card
        document.querySelector('.privacy-card').classList.remove('hidden');
